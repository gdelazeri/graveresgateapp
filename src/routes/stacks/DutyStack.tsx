...
import * as DutyDetailsScreen from "@screens/Duty/DutyDetails";
...
const DutyStack = () => (
  <Stack.Navigator>
    ...
    />
    <Stack.Screen
      name={routeMap.DutyRoutes.DUTY_DETAILS}
      // @ts-ignore
      component={DutyDetailsScreen.default}
      // @ts-ignore
      options={{ header: DutyDetailsScreen.NavHeader }}
    />
    <Stack.Screen
