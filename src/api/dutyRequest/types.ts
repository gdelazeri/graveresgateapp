...
export const DutyShiftLabelTimes = {
  [DutyShift.DAY]: `${DutyShiftLabel[DutyShift.DAY]} - ${
    DutyShiftTimes[DutyShift.DAY].start
  } às ${DutyShiftTimes[DutyShift.DAY].end}`,
  [DutyShift.NIGHT]: `${DutyShiftLabel[DutyShift.NIGHT]} - ${
    DutyShiftTimes[DutyShift.NIGHT].start
  } às ${DutyShiftTimes[DutyShift.NIGHT].end}`,
};
...
export const DutyRequestErrorCodeMessage = {
  [DutyRequestErrorCode.DutyRequestInexistent]:
    "Marcação de plantão não encontrada",
  [DutyRequestErrorCode.DutyRequestExistent]:
    "Já existe uma solicitação para a data e turno selecionado. Se quiser alterá-la você precisa cancelar a solicitação existente e criar uma nova.",
};
