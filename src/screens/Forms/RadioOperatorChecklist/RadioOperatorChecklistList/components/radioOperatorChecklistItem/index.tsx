...
interface RadioOperatorChecklistItemProps {
  item: RadioOperatorChecklist;
  onPress: () => void;
}

const RadioOperatorChecklistItem = ({ item, onPress }: RadioOperatorChecklistItemProps) => (
  <ListItem
...
export default RadioOperatorChecklistItem;
