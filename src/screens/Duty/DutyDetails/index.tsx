    ...
    <>
      <Styled.ScrollView>
        ...
        >
          ...
          <Label size="medium">
            {isString(leader?.name) ? leader?.name : "-"}
          </Label>
          ...
          <Label size="medium">
            {isString(driver?.name) ? driver?.name : "-"}
          </Label>
          ...
          <Label size="medium">
            {isString(firstRescuer?.name) ? firstRescuer?.name : "-"}
          </Label>
          ...
          <Label size="medium">
            {isString(secondRescuer?.name) ? secondRescuer?.name : "-"}
          </Label>
          ...
          <Label size="medium">
            {isString(assistantRadioOperator?.name)
              ? assistantRadioOperator?.name
              : "-"}
          </Label>
          ...
          <Label size="medium">
            {isString(radioOperator?.name) ? radioOperator?.name : "-"}
          </Label>
          ...
          <Label size="medium">
            {isString(trainee?.name) ? trainee?.name : "-"}
          </Label>
        </CardInfo>
        ...
        <CardInfo title="Checklists">
          {dutyChecklists.length === 0 && (
            <EmptyList text="Nenhum checklist preenchido" />
          )}
        ...
        <CardInfo title="Fichas de atendimento">
          {dutyCareChecklists.length === 0 && (
            <EmptyList text="Nenhuma ficha de atendimento" />
          )}
