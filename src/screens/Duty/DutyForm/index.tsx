      ...
      <Styled.ScrollView>
        <CardInfo title="Equipe do plantão">
          <DutyUserPosition
            ...
            dutyRequest={leaderRequests.find(
              (dutyRequest) => dutyRequest.userId === leader?.id,
            )}
            user={leader}
          ...
          <DutyUserPosition
            ...
            dutyRequest={driverRequests.find(
              (dutyRequest) => dutyRequest.userId === driver?.id,
            )}
            user={driver}
          ...
          <DutyUserPosition
            ...
            dutyRequest={rescuerRequests.find(
              (dutyRequest) => dutyRequest.userId === firstRescuer?.id,
            )}
            user={firstRescuer}
          ...
          <DutyUserPosition
            ...
            requestsCount={rescuerRequests.length}
            dutyRequest={rescuerRequests.find(
              (dutyRequest) => dutyRequest.userId === secondRescuer?.id,
            )}
            user={secondRescuer}
          ...
          <DutyUserPosition
            ...
            dutyRequest={assistantRadioOperatorRequests.find(
              (dutyRequest) =>
                dutyRequest.userId === assistantRadioOperator?.id,
            )}
          ...
          <DutyUserPosition
            ...
            dutyRequest={radioOperatorRequests.find(
              (dutyRequest) => dutyRequest.userId === radioOperator?.id,
            )}
            user={radioOperator}
          ...
          <DutyUserPosition
            ...
            dutyRequest={traineeRequests.find(
              (dutyRequest) => dutyRequest.userId === trainee?.id,
            )}
            user={trainee}
...
export const NavHeader = ({
  ...
  const title = `${moment(duty.date).format("ddd")}, ${moment(duty.date).format(
    "LL",
